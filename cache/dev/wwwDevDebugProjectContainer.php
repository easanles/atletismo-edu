...
/**
 * wwwDevDebugProjectContainer
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class wwwDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'EasanlesAtletismoBundle' => 'Easanles\\AtletismoBundle\\EasanlesAtletismoBundle',
            ...
            'kernel.container_class' => 'wwwDevDebugProjectContainer',
            'database_driver' => 'pdo_mysql',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'symfony',
            'database_user' => 'root',
            'database_password' => 'NqxDcxxr',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '627cd7854410f2e0bd2661207cf31025ca',
            'database_path' => NULL,
            ...
            'kernel.secret' => '627cd7854410f2e0bd2661207cf31025ca',
            ...
            'router.options.matcher.cache_class' => 'wwwDevUrlMatcher',
            'router.options.generator.cache_class' => 'wwwDevUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => (__DIR__.'/assetic/routing.yml'),
            'router.cache_class_prefix' => 'wwwDev',
            ...
            'debug.container.dump' => (__DIR__.'/wwwDevDebugProjectContainer.xml'),
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'NqxDcxxr', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(__DIR__)).'/src/Easanles/AtletismoBundle/Entity'))), 'Easanles\\AtletismoBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('EasanlesAtletismoBundle' => 'Easanles\\AtletismoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d822c33f4c57a4634a33bbd7856a3777f60b1eabaf1e4731946ccf87491b738c');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views'), 'Framework');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views'), 'Security');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views'), 'Twig');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/symfony/swiftmailer-bundle/Resources/views'), 'Swiftmailer');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/doctrine/doctrine-bundle/Resources/views'), 'Doctrine');
        $instance->addPath((dirname(dirname(__DIR__)).'/src/Acme/HelloBundle/Resources/views'), 'AcmeHello');
        $instance->addPath((dirname(dirname(__DIR__)).'/src/Easanles/AtletismoBundle/Resources/views'), 'EasanlesAtletismo');
        $instance->addPath((dirname(dirname(__DIR__)).'/src/Acme/DemoBundle/Resources/views'), 'AcmeDemo');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views'), 'WebProfiler');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views'), 'SensioDistribution');
        $instance->addPath((dirname(dirname(__DIR__)).'/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('627cd7854410f2e0bd2661207cf31025ca');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => (dirname(dirname(__DIR__)).'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')));
